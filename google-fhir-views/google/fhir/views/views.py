...
class Views:
  ...
  def view_of(self, structdef_url: str) -> View:
    ...
    struct_type = _fhir_path_data_types.StructureDataType(
        structdef.url.value, structdef.type.value)
    builder = expressions.Builder(
        _evaluation.RootMessageNode(struct_type), self._context, self._handler)
