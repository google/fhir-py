...
"""Support for the WithoutNode."""
from google.fhir.core.execution.queries import relationship_clause_node


class WithoutNode(relationship_clause_node.RelationshipClauseNode):
